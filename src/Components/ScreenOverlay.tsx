 ...
 * @param {number} [props.zIndex] An optional z-index to overwrite the default.
...
function ScreenOverlay({ active, zIndex, disable} : ScreenOverlayProps) {
    return (
